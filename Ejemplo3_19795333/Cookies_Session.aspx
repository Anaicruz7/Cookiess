<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cookies_Session.aspx.cs" Inherits="Ejemplo3_19795333.Cookies_Session" %>
...
<body>
    ...
    <asp:TextBox ID="txtNumberInStock" runat="server"></asp:TextBox>
                        <asp:TextBox ID="txtValueInStock" runat="server"></asp:TextBox>
                        <br /><br />

    <label for="numberOnOrder">Number on Order:</label>
    <asp:TextBox ID="txtNumberOnOrder" runat="server"></asp:TextBox>
                        <asp:TextBox ID="txtValueOnOrder" runat="server"></asp:TextBox>
                        <br /><br />
